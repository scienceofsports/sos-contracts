        ...
        {(() => {
          ...
          return (
            <React.Fragment>
              ...
              <p className="text-sm text-slate-700 mb-2">Either Party may terminate this Agreement with three (3) months' written notice, or immediately in the event of a material breach not remedied within thirty (30) days. Where the Client terminates for convenience before the end of the then-current term, all fees for the remainder of that term shall become immediately due and payable.</p>
